...
from evgen.code_generators.c_sharp import dict_tracker_generator as dtg
from evgen.code_generators.c_sharp import single_param_tracker_generator as stg
...
class CSharpGenerator:
    ...
    def create(cls, dir_path: Path, class_name: str, single_param_tracker: bool):
        if single_param_tracker:
            ...
            return dtg.DictTrackerGenerator(dir_path=dir_path, class_name=class_name)
