...
class EvgenAnalytics(private val eventTracker: EvgenAnalyticsTracker, private val globalParamsProvider: EvgenAnalyticsGlobalParamsProvider, private val platformParamsProvider: EvgenAnalyticsPlatformParamsProvider) {
     ...
     */
    fun shopShowed(page: String, pageId: Int) {
     ...
     */
    fun showcaseMovieShowed(page: String, movieName: String, movieId: Int, pageId: Int) {
        val parameters = mutableMapOf<String, Any>()
        parameters["page"] = page
     ...
     */
    fun showcaseTVShowShowed(page: String, movieName: String, pageId: Int) {
        val parameters = mutableMapOf<String, Any>()
        parameters["page"] = page
        parameters["movieName"] = movieName
        parameters["pageId"] = pageId.toString()
